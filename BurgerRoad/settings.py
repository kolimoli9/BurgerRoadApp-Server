...
SECRET_KEY = 'django-insecure-81sj5_-k77%3n+60&5dd!_n5xo6ic92*lwg&euh3^ozud-op=e'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','base','corsheaders',
...
WSGI_APPLICATION = 'BurgerRoad.wsgi.application'
